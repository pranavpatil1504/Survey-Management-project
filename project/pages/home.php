                            ...
                            <div class="card-body">
                                ...
                                <form id="surveyForm" method="POST" action="submit_survey.php">
                                    ...
                                    <div class="d-flex justify-content-between mt-3">
                                        <?php if ($index > 0): ?>
                                            <button class="btn btn-secondary" type="button" data-target="#surveyCarousel" data-slide="prev">Previous</button>
                                        <?php endif; ?>
                                        <?php if ($index < count($survey) - 1): ?>
                                            <button class="btn btn-primary" type="button" data-target="#surveyCarousel" data-slide="next">Next</button>
                                        <?php else: ?>
