...
<head>
    ...
    <style>
        .background-container {
            ...
            width: 100%;
            height: 110vh;
            background-image: url('../assets/background-image.jpg'); /* Change to your image path */
            background-size: 52%;
        ...
        .signin-container {
            ...
            margin-left: 40%;
            border-radius: 20px;
            box-shadow: 0px 0px 30px rgba(255, 255, 255, 1.9);
            max-width: 500px;
        }
    ...
    <div class="background-container">
        <div class="signin-container">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <h1 class="text-center mt-5"><strong>Sign In</strong></h1>
                    <form method="post" action="signin.php" novalidate>
                        <div class="form-group">
                            <label for="employee_id">Employee ID:</label>
                            <div class="input-group">
                                <input type="number" class="form-control <?= isset($errors['employee_id']) ? 'is-invalid' : '' ?>"
                        ...
                        <button type="button" id="signInButton" class="btn btn-primary btn-block disabled">Sign In</button>
                    </form>
