                    ...
                    <div class="card-body">
                        <form method="POST" action="update_user.php">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="edit_username" name="edit_username" value="" required>
                            </div>
                            <div class="form-group">
                                <label for="edit_email"><strong>Edit Email Address:</strong></label>
                                <input type="email" class="form-control" id="edit_email" name="edit_email" value="<?php echo htmlspecialchars($user['email']); ?>" required>
                            </div>
