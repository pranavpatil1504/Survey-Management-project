...
<body>
    <div class="container">
        <h1 class="mt-4 mb-4">Survey Management</h1>
                    ...
                    <form method="POST" action="?page=survey">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="edit_question_text"
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="?page=survey" class="mt-3">
                        ...
                        <button type="button" class="btn btn-secondary" data-toggle="modal"
                            data-target="#addOptionModal" data-question-id="<?php echo $question['question_id']; ?>">Add
                            Option</button>
                    </form>
                        ...
                        <li class="list-group-item">
                            ...
                            <form method="POST" action="?page=survey" class="d-inline-block float-right ml-2">
                                ...
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                    ...
                                    data-option-id="<?php echo $option['option_id']; ?>">Delete</button>
                            </form>
