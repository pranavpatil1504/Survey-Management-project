    ...
    <div class="signin-container">
        <div class="row justify-content-center">
            <div class="col-md-4" style="margin-left: 45%; margin-top: -33%">
                <h2 class="text-center mt-3 " style="color: #365E32; font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 40px; font-weight: bold"><strong>Sign Up</strong></h2>
                <form method="post" action="signup.php" novalidate>
                    ...
                    <div class="form-group">
                        <label for="confirm_password" style="color: #31363F; font-family: monospace">Confirm Password:</label>
                        <div class="input-group">
                            <input type="password" style="border-color: #365E32; border-radius: 10px 0px 0px 10px"
                    ...
                    <div class="form-group">
                        <label for="security_question" style="color: #31363F; font-family: monospace">Security Question:</label>
                        <select class="form-control <?= isset($errors['security_question']) ? 'is-invalid' : '' ?>"
                            id="security_question" name="security_question" style="border-color: #365E32; border-radius: 10px" required>
                    ...
                    <div class="form-group">
                        <label for="security_answer" style="color: #31363F; font-family: monospace">Security Answer:</label>
                    ...
                    <button type="submit" class="btn btn-primary btn-block" style="background-color: #365E32; border: none; font-weight: bolder; border-radius: 10px">Sign Up</button>
                </form>
