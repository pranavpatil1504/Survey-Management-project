...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    } elseif ($_POST['employee_id'] < 0 || $_POST['employee_id'] > 99999) {
...
<body style="background-color: #E0FBE2">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-6 col-md-6 d-none d-md-block d-xl-block d-lg-block"
                style="margin: 120px auto; right: 30px">
                <img src="../assets/survey.png" class="img-fluid" alt="Responsive Image">
            </div>
            <div class="col-xl-5 col-md-6 col-xs-4 col-lg-6">
                ...
                <form method="post" action="signin.php" novalidate>
                    ...
                    <!-- CAPTCHA Card -->
                    <div class="card mt-3"
                        style="border-color: #365E32; border-radius: 10px; background-color: #E0FBE2">
                        <div class="card-body"
                            style="color: #365E32; border-radius: 0px 10px 10px 0px; font-family: monospace">
                            <h5 class="card-title">CAPTCHA</h5>
                            <p class="card-text" style="color: #31363F; font-weight: bold">Select all images with
                                <?= $captchaData['category'] ?>.
                            </p>
                    ...
                    <button type="button" id="signInButton" class="btn btn-primary btn-block disabled"
                        style="margin-top: 3%; background-color: #365E32; border: none; font-weight: bolder; border-radius: 10px">Sign
                        In</button>
                </form>
