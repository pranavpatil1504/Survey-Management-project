...
// Define the format for the datetime stamp
$datetimeFormat = 'd-m-Y_H-i-s';
$datetimeStamp = date($datetimeFormat);
$backupFile = 'backup_' . $datetimeStamp . '.sql';
...
$datetimeFormat = 'd-m-Y_H-i-s';
$datetimeStamp = date($datetimeFormat);
$backupFile = 'backup_' . $datetimeStamp . '.json';
    $tables = array();
...
$datetimeFormat = 'd-m-Y_H-i-s';
$datetimeStamp = date($datetimeFormat);
$backupFile = 'backup_' . $datetimeStamp . '.pdf';
