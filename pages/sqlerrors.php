...
<body>
    <div class="error-container">
        <img src="../assets/sqlerrors.png" alt="Server Not Found Image" class="error-image">
        <div class="error-text">
            <h1>We're having trouble finding the Server/Database...</h1>
            <p>Please contact the admin</p>
            <button class="btn btn-md btn-danger" onclick="destroySessionAndRedirect()">
                <a href="signin.php" style="text-decoration: none">Close</a>
            </button>
        </div>
    </div>
